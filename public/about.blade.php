        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6">
            ...
            <ul>
                            ...
                            <li class="active"><a href="/aboutt">About Us</a>
                            </li>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="about__item">
              <h4>Apa Itu Rachell Sepeda</h4>
              <p>Rachell Sepeda Merupakan,Toko Yang Menjual Berbagai Macam Sepeda Dan Juga Menjual Berbagai, Sparepart Dan Aksesories Sepeda.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="about__item">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="about__item">
              <h4>Alamat</h4>
              <p>Jl. Otto Iskandardinata No.195, Karanganyar, Kec. Subang, Kabupaten Subang, Jawa Barat.</p>
            </div>
          </div>
        </div>
      </div>
